...
@section('main')
<h1 class="margin-bottom">Tambah Pos Baru</h1>

<ol class="breadcrumb 2">
	<li>
		<a href="#"><i class="fa-home"></i>Pos</a>
	</li>
	<li class="active">
		<strong>Tambah Pos Baru</strong>
	</li>
</ol>
<br />
<style>
...
<form method="post" action="{{route('save_post')}}" role="form" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control input-lg" name="title" placeholder="Post title" required />
		</div>
	</div>
	<br />
	<div class="row">
