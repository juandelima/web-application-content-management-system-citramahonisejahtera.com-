...
@section('main')
<h1 class="margin-bottom">Edit Event</h1>
...
<form method="post" action="{{route('update_event', $event->id_event)}}" role="form" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control input-lg" name="title" placeholder="Post title" required value="{{$event->title}}" />
		</div>
	</div>
	<br />
	<div class="row">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="fileinput fileinput-new" data-provides="fileinput">
				<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
					<img @if ($event->img != '') src="{{ asset('pengguna/'.$event->img) }}" @else src="http://placehold.it/200x150" @endif alt="...">
				</div>
		...
		<input type="hidden" name="gambar_lama" value="{{ $event->img }}" />
	</div>
</form>
@section('scripts')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            var content = {!! json_encode($event->konten) !!};
