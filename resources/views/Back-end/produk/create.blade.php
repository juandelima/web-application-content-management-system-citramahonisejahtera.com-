...
<h1 class="margin-bottom">Tambah Produk Baru</h1>
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{route('save_a_product')}}" method="post" enctype="multipart/form-data">
