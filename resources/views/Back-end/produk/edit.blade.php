...
<h1 class="margin-bottom">Ubah Produk</h1>

<ol class="breadcrumb 2">
	<li>
		<a href="{{route('index_produk')}}"><i class="fa-home"></i>Produk</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{route('update_a_product', $produk->id_produk)}}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							@foreach($kproduks as $row)
								<option value="{{$row->id_kategori}}" @if($row->id_kategori == $produk->kategori_produk_id) selected @endif>{{$row->nama_kategori}}</option>
							@endforeach
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
									<img @if ($produk->featured_image != '') src="{{ asset('produk/'.$produk->featured_image) }}" @else src="http://placehold.it/200x150" @endif alt="...">
								</div>
						...
						<input type="hidden" name="gambar_lama" value="{{ $produk->featured_image }}" />
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-2 control-label" style="text-align:left;">&emsp;Nama Produk</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="nama_produk" value="{{$produk->nama_produk}}" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-2 control-label" style="text-align:left;">&emsp;Deskripsi Produk</label>
						<div class="col-sm-8">
						...
						<div id="foto_<?= $i; ?>" style="margin-top: 15px;">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
										<img @if ($row->sub_img != '') src="{{ asset('produk/'.$row->sub_img) }}" @else src="http://placehold.it/200x150" @endif alt="...">
										</div>
										<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
										<div>
											<span class="btn btn-white btn-file">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var content = {!! json_encode($produk->deskripsi) !!};
