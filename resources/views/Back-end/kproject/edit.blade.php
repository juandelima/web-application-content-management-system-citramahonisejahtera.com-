...
<ol class="breadcrumb 2">
	<li>
		<a href="{{route('kategori_proyek')}}"><i class="fa-home"></i>Kategori Proyek</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{route('update_proyek', $proyek->id_kategori)}}" method="post">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Nama Kategori</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nama_kategori" required value="{{$proyek->nama_kategori}}">
						</div>
					</div>
